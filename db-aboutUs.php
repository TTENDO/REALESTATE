						...
						<div class="team-member">
							...
							<div class="member-info">
								...
								<div class="member-contact">
									<p><i class="fa fa-phone"></i>(+256) 752 500 600</p>
									<p><i class="fa fa-envelope"></i>tonymawejje@gep.com</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-member">
							...
							<div class="member-info">
								...
								<div class="member-contact">
									<p><i class="fa fa-phone"></i>(+256) 783 111 111</p>
									<p><i class="fa fa-envelope"></i>sashmuwonge@gep.com</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-member">
							...
							<div class="member-info">
								...
								<span>Real Estate Agent</span>
								<div class="member-contact">
									<p><i class="fa fa-phone"></i>(+256) 705 351 896</p>
									<p><i class="fa fa-envelope"></i>nickyzamba@gep.com</p>
								</div>
							</div>
						</div>
					</div>
