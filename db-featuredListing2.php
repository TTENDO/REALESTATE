...
<body>
	...
	<section class="page-top-section set-bg" data-setbg="img/partner/bed.jpg">
		<div class="container text-white">
			<h2>Dashboard-Featured Listings 2</h2>
		</div>
	</section>
	<!--  Page top end -->
	...
	<div class="site-breadcrumb">
		<div class="container">
			...
			<span><i class="fa fa-angle-right"></i>Featured Listings 2</span>
		</div>
	</div>
	...
	<section class="page-section categories-page">
		<div class="container">
			...
			<div class="site-pagination">
				<a href="db-featuredListing1.php">1</a>
				<span href="db-featuredListing2.php">2</span>
