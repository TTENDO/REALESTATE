...
<body>
				...
				<div class="row">
					...
					<div class="col-lg-8 text-lg-right header-top-right">
						...
						<ul class="main-menu" >
							...
							<li><a href="try.php">FEATURED LISTING</a></li>
	...
	<section class="page-top-section set-bg" data-setbg="img/partner/bed.jpg">
		<div class="container text-white">
			<h2>Dashboard-Featured Listings</h2>
		</div>
	</section>
	<!--  Page top end -->
	...
	<section class="page-section categories-page">
		<div class="container">
			...
			<div class="site-pagination">
				<span href="categories1.php">1</span>
				<a href="categories2.php">2</a>
				<a href="categories3.php">3</a>
